...
// The following are implementation details for the above macros. The "Impl"
// functions accept values constructed by the macros, and the values are
// guaranteed to be alive for the duration of the function call. Passing the
// macro arguments through a function call is important to support macro
// arguments that expand to short-lived values (which could not be bound
