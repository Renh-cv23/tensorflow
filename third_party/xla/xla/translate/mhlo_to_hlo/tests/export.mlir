...
func.func @main(%arg0: tensor<128x32xf32>) -> tensor<128x128xf32> {
  ...
  %1 = "mhlo.async_done"(%0) {execution_thread = "main"} : (!mhlo.async_bundle<tensor<128x32xf32>, tensor<128x128xf32>>) -> tensor<128x128xf32>
...
func.func @main(%arg0: tensor<10xf32>) -> tensor<10xf32> {
  ...
  %1 = "mhlo.async_done"(%0) {execution_thread = "main"} : (!mhlo.async_bundle<tensor<10xf32>, tensor<10xf32>>) -> tensor<10xf32>
...
func.func @main(%arg0: tensor<10xf32>, %arg1: tensor<1xf32>) -> (tensor<10xf32>, tensor<1xf32>) {
  ...
  %1:2 = "mhlo.async_done"(%0) {execution_thread = "main"} : (!mhlo.async_bundle<tuple<tensor<10xf32>,tensor<1xf32>>, tuple<tensor<10xf32>,tensor<1xf32>>>) -> (tensor<10xf32>, tensor<1xf32>)
...
func.func @main(%arg0: tensor<8x2xf32>, %arg1: tensor<8x4xf32>) -> (tensor<8x2xf32>, tensor<8x4xf32>) {
  ...
  %1:2 = "mhlo.async_done"(%0) {execution_thread = "main"} : (!mhlo.async_bundle<tuple<tensor<8x2xf32>,tensor<8x4xf32>>, tuple<tensor<8x2xf32>,tensor<8x4xf32>>>) -> (tensor<8x2xf32>, tensor<8x4xf32>)
...
func.func @main(%arg0: tensor<128x32xf32>) -> tensor<128x32xf32> {
  ...
  %1 = "mhlo.async_done"(%0) {execution_thread = "main"} : (!mhlo.async_bundle<tensor<128x32xf32>, tensor<128x32xf32>>) -> tensor<128x32xf32>
...
func.func @main(%token: !mhlo.token) -> (!mhlo.token) {
  ...
  %2 = "mhlo.async_done"(%0) {execution_thread = "main"} : (!mhlo.async_bundle<!mhlo.token, !mhlo.token, tensor<i32>>) -> (!mhlo.token)
  return %2 : !mhlo.token
}
...
func.func @main(%token: !mhlo.token) -> (tensor<3x4xi32>, !mhlo.token) {
  ...
  %1, %2 = "mhlo.async_done"(%0) {execution_thread = "main", mhlo.sharding = "{{maximal device=0}, {maximal device=0}}"} : (!mhlo.async_bundle<!mhlo.token, tuple<tensor<3x4xi32>, !mhlo.token>, tensor<i32>>) -> (tensor<3x4xi32>, !mhlo.token)
...
func.func @main(%arg: tensor<3x4xi32>, %token: !mhlo.token) -> !mhlo.token {
  ...
  %1 = "mhlo.async_done"(%0) {execution_thread = "main"} : (!mhlo.async_bundle<tuple<tensor<3x4xi32>, !mhlo.token>, !mhlo.token, tensor<i32>>) -> !mhlo.token
  return %1 : !mhlo.token
}
...
func.func @main(%token: !mhlo.token) -> !mhlo.token {
  ...
  %1 = "mhlo.async_done"(%0) {execution_thread = "main"} : (!mhlo.async_bundle<!mhlo.token, !mhlo.token, tensor<i32>>) -> !mhlo.token
  return %1 : !mhlo.token
}
...
func.func @main(%arg0: tensor<10xf32>) -> tensor<20xf32> {
  ...
  %1 = "mhlo.async_update"(%0) {execution_thread = "thread"} : (!mhlo.async_bundle<tuple<tensor<10xf32>>, tensor<20xf32>, tensor<i32>>) -> !mhlo.async_bundle<tuple<tensor<10xf32>>, tensor<20xf32>, tensor<i32>>
  // CHECK: ROOT %{{.*}} = (f32[20]) async-done(((f32[10]), f32[20], s32[]) %[[UPDATE]])
  %2 = "mhlo.async_done"(%1) {execution_thread = "thread"} : (!mhlo.async_bundle<tuple<tensor<10xf32>>, tensor<20xf32>, tensor<i32>>) -> tensor<20xf32>
