...
func.func @async(%arg0: tensor<10x10xf32>) -> tensor<32xf32> {
  ...
  %1 = "mhlo.async_update"(%0) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<10x10xf32>, tensor<32xf32>, tensor<i32>>) -> !mhlo.async_bundle<tensor<10x10xf32>, tensor<32xf32>, tensor<i32>>
  %2 = "mhlo.async_done"(%1) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<10x10xf32>, tensor<32xf32>, tensor<i32>>) -> tensor<32xf32>
...
func.func @async(%arg0: tensor<10x10xf32>) -> tensor<32xf32> {
  ...
  %1 = "mhlo.async_update"(%0) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<10xf32>, tensor<32xf32>, tensor<i32>>) -> !mhlo.async_bundle<tensor<10xf32>, tensor<32xf32>, tensor<i32>>
  %2 = "mhlo.async_done"(%1) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<10xf32>, tensor<32xf32>, tensor<i32>>) -> tensor<32xf32>
  func.return %2 : tensor<32xf32>
}
...
func.func @async(%arg0: tensor<10x10xf32>) -> tensor<32xf32> {
  ...
  %1 = "mhlo.async_update"(%0) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<10x10xf32>, tensor<f32>, tensor<i32>>) -> !mhlo.async_bundle<tensor<10x10xf32>, tensor<f32>, tensor<i32>>
  %2 = "mhlo.async_done"(%1) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<10x10xf32>, tensor<f32>, tensor<i32>>) -> tensor<32xf32>
  func.return %2 : tensor<32xf32>
}
...
func.func @async(%arg0: tensor<10x10xf32>) -> tensor<32xf32> {
  ...
  %1 = "mhlo.async_update"(%0) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<64xf32>, tensor<32xf32>, tensor<i32>>) -> !mhlo.async_bundle<tensor<64xf32>, tensor<32xf32>, tensor<i32>>
  %2 = "mhlo.async_done"(%1) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<64xf32>, tensor<32xf32>, tensor<i32>>) -> tensor<32xf32>
  func.return %2 : tensor<32xf32>
}
...
func.func @async(%arg0: tensor<10x10xf32>) -> tensor<f32> {
  ...
  %2 = "mhlo.async_done"(%1) {execution_thread="thread"} : (!mhlo.async_bundle<tensor<10x10xf32>, tensor<32xf32>, tensor<i32>>) -> tensor<f32>
